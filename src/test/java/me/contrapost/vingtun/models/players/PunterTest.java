...
public class PunterTest {
    ...
    public void playerReceivedCorrectCards() throws IOException {
        ...
        testSet.getPunter().receiveCards(2);
        ArrayList<Card> cards = testSet.getPunter().getReceivedCards();
    ...
    public void canDrawCardIfLimitIsNotReached() throws IOException {
        ...
        assertFalse(testSet.getPunter().canDrawCard(17));
        assertTrue(testSet.getPunter().canDrawCard(18));
    }
}
