...
public class DealerTest {
    ...
    public void canDrawCardIfPunterHasGreaterScore() throws IOException {
        ...
        int punterScore = getPlayersScore(punter);
        assertTrue(dealer.canDrawCard(punterScore));
        dealer.receiveCards(2); // dealer got CQ and C10 (21)
        assertFalse(dealer.canDrawCard(punterScore));
    }
    ...
    public void dealCardsInCorrectOrder() throws IOException {
        ...
        Dealer dealer = new Dealer(deckFromFile);
        ArrayList<Card> cards = dealer.dealCards(3);
